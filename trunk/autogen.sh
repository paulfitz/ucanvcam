...
if [ "k$1" = "kmingw" ] ; then
    ...
    cmake  -DCMAKE_TOOLCHAIN_FILE=$PWD/../conf/mingwin.cmake -DCMAKE_EXE_LINKER_FLAGS="-L $HOME/mingw/install/lib" -DCMAKE_MODULE_LINKER_FLAGS="-L $HOME/mingw/install/lib" -DCMAKE_SHARED_LINKER_FLAGS="-L $HOME/mingw/install/lib" -DCMAKE_RC_OUTPUT_EXTENSION=".obj" .. && {
	echo " "
	echo "Successful configuration! Compile with:"
	echo "  cd mingw"
	echo "  make"
